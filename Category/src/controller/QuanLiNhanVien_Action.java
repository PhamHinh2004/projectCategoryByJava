...
public class QuanLiNhanVien_Action implements ActionListener, MouseListener{
	Gui_QuanLiNhanVien view ;
	
	
	public QuanLiNhanVien_Action(Gui_QuanLiNhanVien view) {
		super();
		this.view = view;
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		String maNhanVien = (String) this.view.modelNV.getValueAt(location, 0);
		...
		this.view.thongTinVaoBang(new NhanVien(maNhanVien, ten, sdt, diaChi, gioiTinh));
