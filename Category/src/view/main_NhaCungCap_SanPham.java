...
public class main_NhaCungCap_SanPham  extends JFrame implements ActionListener {
    ...
    private JButton btnTiepTucThemSanPham;
	private ImageIcon icon;
    

    public main_NhaCungCap_SanPham () {
...
//      pnlCenter.add(scrollPane, BorderLayout.CENTER);
      ...
      pnlCenter.add(scrollPane, BorderLayout.CENTER);
        ...
        btnTiepTucThemSanPham = new JButton("Tiếp tục thêm sản phẩm");
        pnlSouth.add(btnTiepTucThemSanPham);
        btnTiepTucThemSanPham.addActionListener(this); // Đăng ký sự kiện cho nút "Tiếp tục thêm sản phẩm"
...
//		loaiSanPham.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if(str.trim().compareToIgnoreCase("TRANG CHỦ")==0) {
            ...
            System.exit(0);
        }else if (e.getSource() == btnTiepTucThemSanPham) {
//            // Khi nút "Tiếp tục thêm sản phẩm" được nhấn, tạo và hiển thị giao diện của main_SanPham
//            main_SanPham sanPhamFrame = new main_SanPham();
//            sanPhamFrame.setVisible(true);
//            this.dispose(); // Đóng giao diện của main_NhaCungCap_SanPham
            
            int option = JOptionPane.showConfirmDialog(this, "Phiên bạn nhập lại dữ liệu từ đầu!", "Thông báo", JOptionPane.YES_NO_OPTION);
            if (option == JOptionPane.YES_OPTION) {
                // Đóng giao diện main_NhaCungCap_SanPham
                this.dispose();

                // Mở lại giao diện main_SanPham
                main_SanPham sanPham = new main_SanPham();
