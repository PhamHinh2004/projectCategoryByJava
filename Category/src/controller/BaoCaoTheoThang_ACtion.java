...
public class BaoCaoTheoThang_ACtion implements ActionListener {
	Gui_BaoCaoTheoThang view ;
	

	public BaoCaoTheoThang_ACtion(Gui_BaoCaoTheoThang view) {
		super();
		this.view = view;
	}
