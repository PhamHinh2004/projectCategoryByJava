...
public class SearchSanPham_Action implements ActionListener, MouseListener{
	GUI_TimKiemSanPham view ;
	
	public SearchSanPham_Action(GUI_TimKiemSanPham view) {
		super();
		this.view = view;
	}
	...
	public void mouseClicked(MouseEvent e) {
		// TODO Auto-generated method stub
				int location = this.view.tableSP.getSelectedRow();
				String masP = (String) this.view.modelSP.getValueAt(location, 0);
				String ten = (String) this.view.modelSP.getValueAt(location, 1);
				String hsd = (String) this.view.modelSP.getValueAt(location, 2);
				int trongLuong = Integer.parseInt((String) this.view.modelSP.getValueAt(location, 3));
				String donViTinh = (String) this.view.modelSP.getValueAt(location, 4);
				int soLuong = Integer.parseInt((String) this.view.modelSP.getValueAt(location, 5));
				double donGia = Double.parseDouble((String) this.view.modelSP.getValueAt(location, 6));
				String ncc = (String) this.view.modelSP.getValueAt(location, 7);
				
				this.view.thongTinVaoBang(new SanPham(masP, ten, hsd, donViTinh, donGia, ncc, soLuong, trongLuong));
	}
	...
	public void actionPerformed(ActionEvent e) {
    	...
    	if(str.trim().compareToIgnoreCase("TRANG CHỦ")==0) {
			...
			new Gui_BaoCaoDoanhThu();
					...
					if(this.view.textMaSP.getText().length()!=0) {
