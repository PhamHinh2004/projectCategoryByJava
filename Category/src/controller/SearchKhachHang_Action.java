...
public class SearchKhachHang_Action implements ActionListener, MouseListener{
	Gui_TimKiemKhachHang view ;
	
	public SearchKhachHang_Action(Gui_TimKiemKhachHang view) {
		super();
		this.view = view;
	}
	...
	public void actionPerformed(ActionEvent e) {
    	...
    	if(str.trim().compareToIgnoreCase("TRANG CHỦ")==0) {
			...
			new Gui_BaoCaoDoanhThu();
					...
					if(this.view.textMaKH.getText().length()!=0) {
